...
<form class="layui-form" action="">
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input  lay-verify="required" autocomplete="off" class="layui-input roomNum" name="roomNum" type="text">
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <textarea placeholder="请输入内容" class="layui-textarea roomDesc" name="roomDesc" lay-verify="required" style="width: 500px;"></textarea>
            <p><span id="descCount">200</span>/200</p>
        </div>
    </div>
...
<script>
    layui.use(['jquery','table','layer','form'], function(){
        ...
        //房屋设施文本域字数限制
        $(".roomDesc").on("input propertychange", function () {
            var $this = $(this),
                    _val = $this.val(),
                    count = "";
            if (_val.length > 200) {
